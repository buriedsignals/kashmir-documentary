...
const url = 'https://kashmir.buriedsignals.com/'
const description = 'Lines of Control is an interactive documentary about the conflict in Kashmir. Viewers can ask academic experts questions about Kashmir’s history, the geopolitical stakes between Pakistan and India or the humanitarian toll of the crisis.'
  ...
  return (
    <>
      <Head>
        ...
        <meta property='og:image:alt' content='Lines of Control' />
        ...
        <meta name='twitter:image:alt' content='Lines of Control' />
      </Head>
      <GlobalStyle />
